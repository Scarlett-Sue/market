      ...
      <div class="form-card">
        ...
        <div class="form-content">
          <el-row type="flex" style="flex-wrap:wrap" :gutter="150">
            ...
            <el-col :md="12" :lg="8" :xl="8">
              <el-form-item label="仓库地址" prop="address" :rules="rules.need">
                <el-input v-model="form.address" placeholder="请输入" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :md="12" :lg="8" :xl="8">
              <el-form-item label="仓库类型" prop="type" :rules="rules.intNum">
                <el-input v-model="form.type" placeholder="请输入" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :md="12" :lg="8" :xl="8">
              <el-form-item label="容量" prop="capacity" :rules="rules.need">
                <el-input v-model="form.capacity" placeholder="请输入" ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
